...
export class default1680269788675 implements MigrationInterface {
  name = 'default1680269788675'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "teams" ("team_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "team_name" text NOT NULL, CONSTRAINT "UQ_fee65e62557b5c91d557a1f1501" UNIQUE ("team_name"), CONSTRAINT "PK_10ccce4d7d878c221ee7c5c8057" PRIMARY KEY ("team_id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "requests" ("request_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" text NOT NULL, "status" text NOT NULL, "description" text, "requestType" "public"."requests_requesttype_enum", "requestStep" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "PK_4e7b87d34546d9f21a648aed04d" PRIMARY KEY ("request_id"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "statusConfigurations" ("status_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rating" text NOT NULL, "status" text NOT NULL, "requestStep" "public"."statusConfigurations_requeststep_enum", CONSTRAINT "UQ_70e86ed7c0e66b1e822dc35aea2" UNIQUE ("rating"), CONSTRAINT "PK_e6630724a6ce2f340ec05b6868f" PRIMARY KEY ("status_id"))`
    )
    await queryRunner.query(
