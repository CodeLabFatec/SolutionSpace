...
export class default1683563067834 implements MigrationInterface {
    name = 'default1683563067834'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "groups" ("group_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" text, "group_name" text NOT NULL, "canRequestFeatures" boolean NOT NULL DEFAULT false, "canRequestHotfix" boolean NOT NULL DEFAULT false, "canRateAnalise" boolean NOT NULL DEFAULT false, "mustRateAnalise" boolean NOT NULL DEFAULT false, "canRateAnalinhamento" boolean NOT NULL DEFAULT false, "mustRateAnalinhamento" boolean NOT NULL DEFAULT false, "team_id" uuid, CONSTRAINT "UQ_ef10d4611e4f355d10ecaa10ac6" UNIQUE ("group_name"), CONSTRAINT "PK_7cfd923277f6ef9f89b04c60436" PRIMARY KEY ("group_id"))`);
        await queryRunner.query(`CREATE TABLE "teams" ("team_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "team_name" text NOT NULL, "description" text, "permissionCreateUsers" boolean NOT NULL DEFAULT false, "permissionCreateTeams" boolean NOT NULL DEFAULT false, "permissionCreateGroups" boolean NOT NULL DEFAULT false, "permissionEditRequests" boolean NOT NULL DEFAULT false, "permissionUnarchiveRequests" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_fee65e62557b5c91d557a1f1501" UNIQUE ("team_name"), CONSTRAINT "PK_10ccce4d7d878c221ee7c5c8057" PRIMARY KEY ("team_id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("user_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, "gender" "public"."users_gender_enum", "email" text NOT NULL, "password" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "team_id" uuid, "group_id" uuid, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_96aac72f1574b88752e9fb00089" PRIMARY KEY ("user_id"))`);
        await queryRunner.query(`CREATE TABLE "requests" ("request_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" text NOT NULL, "status" text NOT NULL DEFAULT 'Aberto', "description" text, "requestType" "public"."requests_requesttype_enum", "requestStep" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "colorStatus" text, "arquived" boolean NOT NULL DEFAULT false, "user_id" uuid, CONSTRAINT "PK_4e7b87d34546d9f21a648aed04d" PRIMARY KEY ("request_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "files" ("file_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "file_name" text NOT NULL, "base64" text NOT NULL, "ext" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "request_id" uuid, "rating_id" uuid, CONSTRAINT "PK_a753eb40fcc8cd925fe9c9aded4" PRIMARY KEY ("file_id"))`);
        await queryRunner.query(`CREATE TABLE "statusConfigurations" ("status_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rating" text NOT NULL, "status" text NOT NULL, "requestStep" "public"."statusConfigurations_requeststep_enum", "color" text, "archiveRequests" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_e6630724a6ce2f340ec05b6868f" PRIMARY KEY ("status_id"))`);
        await queryRunner.query(`CREATE TABLE "notifications" ("notification_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" text NOT NULL, "message" text, "hasRead" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "PK_eaedfe19f0f765d26afafa85956" PRIMARY KEY ("notification_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_1208ee1db5ddb64b48a86b46a61" FOREIGN KEY ("team_id") REFERENCES "teams"("team_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "ratings" ADD CONSTRAINT "FK_3cb8f146d96bca48dcca4330f7b" FOREIGN KEY ("request_id") REFERENCES "requests"("request_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "files" ADD CONSTRAINT "FK_2b2d2d8b847afcbd55559acd60a" FOREIGN KEY ("request_id") REFERENCES "requests"("request_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "files" ADD CONSTRAINT "FK_5fa3fbbb01348617185afd39557" FOREIGN KEY ("rating_id") REFERENCES "ratings"("rating_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
