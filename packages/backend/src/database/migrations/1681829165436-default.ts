...
export class default1681829165436 implements MigrationInterface {
    name = 'default1681829165436'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "teams" ("team_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "team_name" text NOT NULL, CONSTRAINT "UQ_fee65e62557b5c91d557a1f1501" UNIQUE ("team_name"), CONSTRAINT "PK_10ccce4d7d878c221ee7c5c8057" PRIMARY KEY ("team_id"))`);
        await queryRunner.query(`CREATE TABLE "groups" ("group_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "group_name" text NOT NULL, CONSTRAINT "UQ_ef10d4611e4f355d10ecaa10ac6" UNIQUE ("group_name"), CONSTRAINT "PK_7cfd923277f6ef9f89b04c60436" PRIMARY KEY ("group_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "statusConfigurations" ("status_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "rating" text NOT NULL, "status" text NOT NULL, "requestStep" "public"."statusConfigurations_requeststep_enum", CONSTRAINT "PK_e6630724a6ce2f340ec05b6868f" PRIMARY KEY ("status_id"))`);
