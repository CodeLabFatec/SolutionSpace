...
const PersonalizacaoAlinhamento: React.FC = () => {
  ...
  const load = async () => {
    try{
      const response = await getStatusConfigurationByRequestStep('AlinhamentoEstrategico')
    ...
    <div className={Styles.container}>
      <div className={Styles.tableContainer}>
        <div className={Styles.title}>
          <h1>Status de alinhamento estratégico</h1>
          <hr />
        </div>
...
export default PersonalizacaoAlinhamento;
